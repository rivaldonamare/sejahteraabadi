...
<html class="no-js" lang="">
  <head>
    ...
    <link rel="apple-touch-icon" href="{{ url('/frontend/images/content/logo_toko_sembako.png') }}" />
    <!-- Place favicon.ico in the root directory -->

    
    <link rel="icon" href="{{url('/frontend/images/content/logo_toko_sembako.png')}}" />

    <meta name="theme-color" content="#000" />
    <link rel="icon" href="{{ url('/frontend/logo_toko_sembako.png') }}">
