...
<section class="flex items-center hero">
      ...
      <div class="container mx-auto">
        <div class="flex flex-start mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            Cari sembako murah <br class="" />pilih sembako sekarang!
          </h3>
        </div>
        <div class="grid grid-rows-2 grid-cols-9 gap-4">
          ...
          >
            <div class="card-shadow rounded-xl">
              <img
                src="/frontend/images/content/mie-instan.png"
                alt=""
          ...
          >
            <div class="card-shadow rounded-xl">
              <img
                src="/frontend/images/content/minyak-goreng.png"
                alt=""
                class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
              />
            </div>
          ...
          >
            <div class="card-shadow rounded-xl">
              <img
                src="/frontend/images/content/susu.png"
                alt=""
                class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
              />
            </div>
          ...
          <div class="relative col-span-9 row-span-1 md:col-span-4 card">
            <div class="card-shadow rounded-xl">
              <img
                src="/frontend/images/content/bumbu-masak.png"
                alt=""
                class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
              />
            </div>
        ...
        <div class="flex -mx-4 flex-row relative">
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/frontend/images/content/kewpie mayo.jpg"
                alt=""
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/frontend/images/content/kikkoman saus teriyaki.jpg"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/frontend/images/content/entrasol.jpg"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/frontend/images/content/frisian flag junio.jpg"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/frontend/images/content/mr brown caramel latte.jpg"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
    ...
    <section class="container mx-auto">
      <div class="flex justify-center flex-wrap">
        ...
        >
          <img src="/frontend/images/content/SUSUbendera smol.png" alt="" class="mx-auto" />
        </div>
        <div
          class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0"
        >
        ...
        >
          <img
            src="/frontend/images/content/Logo-Danone smol.png"
            alt=""
            class="mx-auto"
          />
        </div>
